...
plot(dance_count_v, main = "Dispersion plot of 'dance' in LOL", xlab = "novelistic time", ylab = "dance", type = "h", ylim = c(0,1), yaxt='n')
...
plot(dancing_count_v, main = "Dispersion plot of 'dancing' in LOL", xlab = "novelistic time", ylab = "dancing", type = "h", ylim = c(0,1), yaxt = 'n')
...
plot(danced_count_v, main = "Dispersion plot of 'danced' in LOL", xlab = "novelistic time", ylab = "danced", type = "h", ylim = c(0,1), yaxt = 'n')
...
plot(dances_count_v, main = "Dispersion plot of 'dances' in LOL", xlab = "novelistic time", ylab = "dances", type = "h", ylim = c(0,1), yaxt='n')
...
plot(singing_count_v, main = "Dispersion plot of 'singing' in LoL", xlab = "novelistic time", ylab = "singing", type = "h", ylim = c(0,1), yaxt= 'n')
...
plot(song_count_v, main = "Dispersion plot of 'song' in LOL", xlab = "novelistic time", ylab = "song", type = 'h', ylim = c(0,1), yaxt = 'n')
...
plot(sing_count_v, main = "Dispersion plot of 'sing' in LOL", xlab = "novelistic time", ylab = "sing", type = 'h', ylim = c(0,1), yaxt = 'n')
...
plot(sings_count_v, main = "Dispersion plot of 'sings' in LOL", xlab = "novelistic time", ylab = "sing", type = 'h', ylim = c(0,1), yaxt = 'n')
...
plot(sang_count_v, main = "Dispersion plot of 'sang' in LOL", xlab = "novelistic time", ylab = "sang", type = 'h', ylim = c(0,1), yaxt = 'n')
...
plot(sung_count_v, main = "Dispersion plot of 'sung' in LOL", xlab = "novelistic time", ylab = "sung", type = 'h', ylim = c(0,1), yaxt = 'n')
...
library(tibble)
library(readtext)
text_v <- readtext("C://Users//chris//Downloads//LayofLeithian.txt")
text_v
text_v <- tolower(text_v)
text_v
...
chunky_text <- matrix(unlist(chunky_text), ncol =1, nrow =147)
chunky_text
