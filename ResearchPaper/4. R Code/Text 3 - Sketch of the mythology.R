...
#Text 3 only - Sketch of the Mythology
#============================================================================= #

#Section 1: term frequency basics --------------------------------------------------
#1a counting sing vs dance ........................................................
text_v <- scan("C://Users//chris//Downloads//SketchoftheMythology.txt", what= "character")
text_v
...
totaldancehits_v/total_words_v #which tells us that "danc-" makes up 4.6e-05 of the whole Sketch (nearly 0)
...
#Therefore total number of all iterations of sing- is 4
totalsinghits_v = 4
totalsinghits_v/total_words_v #which tells us that "sing-"'s iterations makes up 0.000018 of the whole Sketch
...
plot(dance_count_v, main = "Dispersion plot of 'dance' in SotM", xlab = "novelistic time", ylab = "dance", type = "h", ylim = c(0,1), yaxt='n')
...
plot(dancing_count_v, main = "Dispersion plot of 'dancing' in SotM", xlab = "novelistic time", ylab = "dancing", type = "h", ylim = c(0,1), yaxt = 'n')
...
plot(danced_count_v, main = "Dispersion plot of 'danced' in SotM", xlab = "novelistic time", ylab = "danced", type = "h", ylim = c(0,1), yaxt = 'n')
...
plot(dances_count_v, main = "Dispersion plot of 'dances' in SotM", xlab = "novelistic time", ylab = "dances", type = "h", ylim = c(0,1), yaxt='n')
...
plot(singing_count_v, main = "Dispersion plot of 'singing' in SotM", xlab = "novelistic time", ylab = "singing", type = "h", ylim = c(0,1), yaxt= 'n')
...
plot(song_count_v, main = "Dispersion plot of 'song' in SotM", xlab = "novelistic time", ylab = "song", type = 'h', ylim = c(0,1), yaxt = 'n')
...
plot(sing_count_v, main = "Dispersion plot of 'sing' in SotM", xlab = "novelistic time", ylab = "sing", type = 'h', ylim = c(0,1), yaxt = 'n')
...
plot(sings_count_v, main = "Dispersion plot of 'sings' in SotM", xlab = "novelistic time", ylab = "sing", type = 'h', ylim = c(0,1), yaxt = 'n')
...
plot(sang_count_v, main = "Dispersion plot of 'sang' in SotM", xlab = "novelistic time", ylab = "sang", type = 'h', ylim = c(0,1), yaxt = 'n')
...
plot(sung_count_v, main = "Dispersion plot of 'sung' in SotM", xlab = "novelistic time", ylab = "sung", type = 'h', ylim = c(0,1), yaxt = 'n')
...
library(tibble)
library(readtext)
text_v <- readtext("C://Users//chris//Downloads//SketchoftheMythology.txt")
text_v
text_v <- tolower(text_v)
text_v
...
chunky_text <- matrix(unlist(chunky_text), ncol =1, nrow =119)
chunky_text
