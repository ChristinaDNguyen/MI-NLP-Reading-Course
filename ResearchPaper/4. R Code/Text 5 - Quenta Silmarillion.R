...
plot(dance_count_v, main = "Dispersion plot of 'dance' in QS", xlab = "novelistic time", ylab = "dance", type = "h", ylim = c(0,1), yaxt='n')
...
plot(dancing_count_v, main = "Dispersion plot of 'dancing' in QS", xlab = "novelistic time", ylab = "dancing", type = "h", ylim = c(0,1), yaxt = 'n')
...
plot(danced_count_v, main = "Dispersion plot of 'danced' in QS", xlab = "novelistic time", ylab = "danced", type = "h", ylim = c(0,1), yaxt = 'n')
...
plot(dances_count_v, main = "Dispersion plot of 'dances' in QS", xlab = "novelistic time", ylab = "dances", type = "h", ylim = c(0,1), yaxt='n')
...
plot(singing_count_v, main = "Dispersion plot of 'singing' in QS", xlab = "novelistic time", ylab = "singing", type = "h", ylim = c(0,1), yaxt= 'n')
...
plot(song_count_v, main = "Dispersion plot of 'song' in QS", xlab = "novelistic time", ylab = "song", type = 'h', ylim = c(0,1), yaxt = 'n')
...
plot(sing_count_v, main = "Dispersion plot of 'sing' in QS", xlab = "novelistic time", ylab = "sing", type = 'h', ylim = c(0,1), yaxt = 'n')
...
plot(sings_count_v, main = "Dispersion plot of 'sings' in QS", xlab = "novelistic time", ylab = "sing", type = 'h', ylim = c(0,1), yaxt = 'n')
...
plot(sang_count_v, main = "Dispersion plot of 'sang' in QS", xlab = "novelistic time", ylab = "sang", type = 'h', ylim = c(0,1), yaxt = 'n')
...
plot(sung_count_v, main = "Dispersion plot of 'sung' in QS", xlab = "novelistic time", ylab = "sung", type = 'h', ylim = c(0,1), yaxt = 'n')
...
library(tibble)
library(readtext)
text_v <- readtext("C://Users//chris//Downloads//QuentaSilmarillion.txt")
text_v
text_v <- tolower(text_v)
text_v
...
chunky_text <- matrix(unlist(chunky_text), ncol =1, nrow =63)
chunky_text
