...
#=================CHAPTER 7: CASE STUDY WITH TWITTER==========================

#Compare the two authors' 
#Twitter archives by using the lubridate package
#to convert the string timestamps to date-time objects that are actually usefull
#for analysis

#Just get the CSV files from the links in the textbook
