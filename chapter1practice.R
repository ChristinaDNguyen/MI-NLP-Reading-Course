...
#4x2, meaning that it is a modern class of data frame within R. It is available in 
#the dplyr and tibble packages, offering a convenient print method. Tibbles are 
#good for tidy tools.
...
#Find most common words in all 6 books as a whole
...
#OK so a graph showed on the right-hand-side of RStudio with all the horizontal bars.
         #The bars show the occurances of each of the top 10 or so words across
         #all 6 books.
